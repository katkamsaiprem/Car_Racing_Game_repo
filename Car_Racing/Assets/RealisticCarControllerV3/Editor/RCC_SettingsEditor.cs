...
public class RCC_SettingsEditor : Editor {
	...
	public override void OnInspectorGUI (){
		...
		if(foldControllerSettings){
			...
			EditorGUILayout.PropertyField(serializedObject.FindProperty("steeringWheelEnabled"), new GUIContent("Steering Wheel Enabled"));

			if (RCCSettingsAsset.steeringWheelEnabled) {

				EditorGUILayout.Space();
				EditorGUI.indentLevel++;
				EditorGUILayout.HelpBox("Steering wheel will be used. In this case, these variables will be overridden for all vehicles; \n Steering Type = 'Constant' \n Steering Limiter = off \n Steer Counter = off \n Steering Sensitivity = off", MessageType.Info);
				EditorGUI.indentLevel--;
				EditorGUILayout.Space();
